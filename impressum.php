...
<html lang="<?php echo $lang['lang'] ?>">
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
		...
		<meta name="keywords" content="Lrud, Leon, Rudowicz, Lrudowicz">
    ...
    <link href="css/main.css" rel="stylesheet" type="text/css">
		<title><?php echo $lang['impressum'] ?></title>
	</head>
	<body>
    <div class="container">
    <nav class="navbar navbar-light navbar-expand-md justify-content-center">
      <a href="/" class="navbar-brand d-flex w-50 mr-auto"><?php echo $lang['head'] ?></a>
      ...
      <div class="navbar-collapse collapse w-100" id="navbarCollapse">
          <ul class="nav navbar-nav ml-auto w-100 justify-content-end">
            <li class="nav-item">
                <a class="nav-link" href=""><?php echo $lang['impressum'] ?></a>
            </li>
            <li class="nav-item">
    ...
    <br>
      <div class="container text-center">
        ...
        <p>Leon Rudowicz<br />
        Weichselstra&szlig;e 32<br />
        10247 Berlin</p>
        <h2>Kontakt</h2>
        <p>Telefon: 0302809010<br />
        E-Mail: info@lrudowicz.de</p>
